      ...
      <section id="about" className="section">
        ...
        <div className="about-content">
          <div className="about-text">
            ...
            <p>
              Eager to contribute my technical expertise and analytical mindset to challenging cybersecurity problems, 
              building secure systems, and advancing the field through continuous learning and innovation.
            </p>
          </div>
